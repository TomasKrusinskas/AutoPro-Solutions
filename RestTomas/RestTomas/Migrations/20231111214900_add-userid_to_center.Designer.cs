...
namespace RestTomas.Migrations
{
    ...
    [Migration("20231111214900_add-userid_to_center")]
    partial class adduserid_to_center
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestTomas.Data.Dtos.Auth.DemoRestUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RestTomas.Data.Dtos.Auth.DemoRestUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RestTomas.Data.Entities.Center", b =>
                {
                    b.HasOne("RestTomas.Data.Dtos.Auth.DemoRestUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
